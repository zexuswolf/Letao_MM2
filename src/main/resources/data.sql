...
insert into LETAO_MM_MATERIAL (ID,THAI_NAME,ENGLISH_NAME,MATERIAL_TYPE_ID,CREATED_AT,UPDATED_AT) VALUES (2,'ชอคโกแลตเค้ก','Chocolate Cake',4,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);